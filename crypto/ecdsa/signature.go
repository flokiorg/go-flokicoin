...
func NewSignature(r, s *crypto.ModNScalar) *Signature {
...
func SignCompact(key *crypto.PrivateKey, hash []byte,
...
func RecoverCompact(signature, hash []byte) (*crypto.PublicKey, bool, error) {
...
// and BIP0062.
func Sign(key *crypto.PrivateKey, hash []byte) *Signature {
