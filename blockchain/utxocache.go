...
func (s *utxoCache) addTxOuts(tx *chainutil.Tx, blockHeight int32) error {
...
// from the cache.
func (s *utxoCache) addTxIns(tx *chainutil.Tx, stxos *[]SpentTxOut) error {
...
func (s *utxoCache) connectTransaction(
	tx *chainutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (s *utxoCache) connectTransactions(block *chainutil.Block, stxos *[]SpentTxOut) error {
