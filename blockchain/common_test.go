...
func addBlock(chain *BlockChain, prev *chainutil.Block, spends []*testhelper.SpendableOut) (
	*chainutil.Block, []*testhelper.SpendableOut, error) {
...
func newBlock(chain *BlockChain, prev *chainutil.Block,
	spends []*testhelper.SpendableOut) (*chainutil.Block, []*testhelper.SpendableOut, error) {
