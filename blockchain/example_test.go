...
// overview documentation describes, this includes all of the Flokicoin consensus
...
func ExampleBlockChain_ProcessBlock() {
	...
	// the main flokicoin network.  This example does not demonstrate some
	...
	isMainChain, isOrphan, err := chain.ProcessBlock(genesisBlock, blockchain.BFNone)
	if err != nil {
	...
	// Output:
	// Failed to process block: already have block c99abcc69738ab0bb2e65d6e08c48a4fae0f529bbaf1aa6bfb55b12d6d8ec47e
}
