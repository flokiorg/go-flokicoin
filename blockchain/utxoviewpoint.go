...
func (view *UtxoViewpoint) AddTxOut(tx *chainutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *chainutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *chainutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *chainutil.Block, stxos []SpentTxOut) error {
...
// outpoints.
func (view *UtxoViewpoint) findInputsToFetch(block *chainutil.Block) []wire.OutPoint {
...
// are not modified.
func (view *UtxoViewpoint) fetchInputUtxos(cache *utxoCache, block *chainutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *chainutil.Tx) (*UtxoViewpoint, error) {
