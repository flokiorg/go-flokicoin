...
type RawTxWitnessInput struct {
	...
	Amount        *float64 `json:"amount,omitempty"` // In FLC
}
...
// WalletCreateFundedPsbtCmd command.
func NewPsbtOutput(address string, amount chainutil.Amount) PsbtOutput {
	return PsbtOutput{address: amount.ToFLC()}
}
