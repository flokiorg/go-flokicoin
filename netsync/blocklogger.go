...
func newBlockProgressLogger(progressMessage string, logger flog.Logger) *blockProgressLogger {
...
func (b *blockProgressLogger) LogBlockHeight(block *chainutil.Block, chain *blockchain.BlockChain) {
	b.Lock()
	defer b.Unlock()
