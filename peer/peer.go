...
type MessageListeners struct {
	// OnGetAddr is invoked when a peer receives a getaddr flokicoin message.
	OnGetAddr func(p *Peer, msg *wire.MsgGetAddr)

	// OnAddr is invoked when a peer receives an addr flokicoin message.
	OnAddr func(p *Peer, msg *wire.MsgAddr)

	// OnAddrV2 is invoked when a peer receives an addrv2 flokicoin message.
	OnAddrV2 func(p *Peer, msg *wire.MsgAddrV2)

	// OnPing is invoked when a peer receives a ping flokicoin message.
	OnPing func(p *Peer, msg *wire.MsgPing)

	// OnPong is invoked when a peer receives a pong flokicoin message.
	OnPong func(p *Peer, msg *wire.MsgPong)

	// OnAlert is invoked when a peer receives an alert flokicoin message.
	OnAlert func(p *Peer, msg *wire.MsgAlert)

	// OnMemPool is invoked when a peer receives a mempool flokicoin message.
	OnMemPool func(p *Peer, msg *wire.MsgMemPool)

	// OnTx is invoked when a peer receives a tx flokicoin message.
	OnTx func(p *Peer, msg *wire.MsgTx)

	// OnBlock is invoked when a peer receives a block flokicoin message.
	OnBlock func(p *Peer, msg *wire.MsgBlock, buf []byte)

	// OnCFilter is invoked when a peer receives a cfilter flokicoin message.
	OnCFilter func(p *Peer, msg *wire.MsgCFilter)

	// OnCFHeaders is invoked when a peer receives a cfheaders flokicoin
	// message.
	OnCFHeaders func(p *Peer, msg *wire.MsgCFHeaders)

	// OnCFCheckpt is invoked when a peer receives a cfcheckpt flokicoin
	// message.
	OnCFCheckpt func(p *Peer, msg *wire.MsgCFCheckpt)

	// OnInv is invoked when a peer receives an inv flokicoin message.
	OnInv func(p *Peer, msg *wire.MsgInv)

	// OnHeaders is invoked when a peer receives a headers flokicoin message.
	OnHeaders func(p *Peer, msg *wire.MsgHeaders)

	// OnNotFound is invoked when a peer receives a notfound flokicoin
	// message.
	OnNotFound func(p *Peer, msg *wire.MsgNotFound)

	// OnGetData is invoked when a peer receives a getdata flokicoin message.
	OnGetData func(p *Peer, msg *wire.MsgGetData)

	// OnGetBlocks is invoked when a peer receives a getblocks flokicoin
	// message.
	...
	// OnGetCFilters is invoked when a peer receives a getcfilters flokicoin
	// message.
	...
	// OnFeeFilter is invoked when a peer receives a feefilter flokicoin message.
	OnFeeFilter func(p *Peer, msg *wire.MsgFeeFilter)

	// OnFilterAdd is invoked when a peer receives a filteradd flokicoin message.
	OnFilterAdd func(p *Peer, msg *wire.MsgFilterAdd)

	// OnFilterClear is invoked when a peer receives a filterclear flokicoin
	// message.
	OnFilterClear func(p *Peer, msg *wire.MsgFilterClear)

	// OnFilterLoad is invoked when a peer receives a filterload flokicoin
	// message.
	OnFilterLoad func(p *Peer, msg *wire.MsgFilterLoad)

	// OnMerkleBlock  is invoked when a peer receives a merkleblock flokicoin
	// message.
	OnMerkleBlock func(p *Peer, msg *wire.MsgMerkleBlock)

	// OnVersion is invoked when a peer receives a version flokicoin message.
	...
	// OnVerAck is invoked when a peer receives a verack flokicoin message.
	OnVerAck func(p *Peer, msg *wire.MsgVerAck)

	// OnReject is invoked when a peer receives a reject flokicoin message.
	OnReject func(p *Peer, msg *wire.MsgReject)

	// OnSendHeaders is invoked when a peer receives a sendheaders flokicoin
	// message.
	...
	// OnRead is invoked when a peer receives a flokicoin message.  It
	...
	// OnWrite is invoked when we write a flokicoin message to a peer.  It
...
// net.Addr interface and create a flokicoin NetAddress structure using that
// information.
...
// Peer provides a basic concurrent safe flokicoin peer for handling flokicoin
...
// callbacks for handling flokicoin protocol messages.
//
...
// handlePingMsg is invoked when a peer receives a ping flokicoin message.  For
...
// handlePongMsg is invoked when a peer receives a pong flokicoin message.  It
...
// readMessage reads the next flokicoin message from the peer with logging.
...
// writeMessage sends a flokicoin message to the peer with logging.
...
// QueueMessage adds the passed flokicoin message to the peer send queue.
//
// This function is safe for concurrent access.
...
// QueueMessageWithEncoding adds the passed flokicoin message to the peer send
...
// NewInboundPeer returns a new inbound flokicoin peer. Use Start to begin
// processing incoming and outgoing messages.
func NewInboundPeer(cfg *Config) *Peer {
	return newPeerBase(cfg, true)
}

// NewOutboundPeer returns a new outbound flokicoin peer. If the Config argument
