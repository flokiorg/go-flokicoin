...
var (
	...
	mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 240), bigOne) // #FLOKI_CHANGE
...
type Params struct {
	...
	// EarlyPowLimitBits defines a different proof of work limit for the first three blocks.
	EarlyPowLimitBits uint32
...
var MainNetParams = Params{
	...
	EarlyPowLimitBits:        0x1e56b940,
	BIP0034Height:            0,
	BIP0065Height:            0,
	BIP0066Height:            0,
	CoinbaseMaturity:         300,             // 300 => 5h
	SubsidyReductionInterval: 265_000,         // interval of blocks before halving = 6 months
	...
	Deployments: [DefinedDeployments]ConsensusDeployment{
		...
		DeploymentTaproot: {
			BitNumber: 2,
			DeploymentStarter: NewMedianTimeDeploymentStarter(
				time.Unix(1740783600, 0), // Mar 1th, 2025
			),
			DeploymentEnder: NewMedianTimeDeploymentEnder(
				time.Unix(1743458400, 0), // Apr 1th, 2025
			),
			// CustomActivationThreshold: 6480, // 90%
			// MinActivationHeight:       115_630,
		},
	},
...
var RegressionNetParams = Params{
	...
	TargetTimespan:           time.Hour * 1,   // 1 minute
	TargetTimePerBlock:       time.Minute * 1, // 1 minute
	RetargetAdjustmentFactor: 4,               // 25% less, 400% more
...
var TestNet3Params = Params{
	...
	SubsidyReductionInterval: 265_000,
	TargetTimespan:           time.Minute * 1, // 1 minute
	TargetTimePerBlock:       time.Minute * 1, // 1 minute
	RetargetAdjustmentFactor: 4,               // 25% less, 400% more
	ReduceMinDifficulty:      true,
