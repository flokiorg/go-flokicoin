...
//
// In addition to the main Flokicoin network, which is intended for the transfer
...
// wire.FlokicoinNet using ParamsForNet, but be aware that this usage is
...
//	)
//
//	var testnet = flag.Bool("testnet", false, "operate on the testnet Flokicoin network")
//
...
//	}
//
// If an application does not use one of the three standard Flokicoin networks,
