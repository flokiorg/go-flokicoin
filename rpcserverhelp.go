...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, FLCD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in FLC as the value",
	...
	"scriptpubkeyresult-address":   "The flokicoin address associated with this script (only if a well-defined address exists)",
	"scriptpubkeyresult-addresses": "(DEPRECATED) The flokicoin addresses associated with this script",

	// Vout help.
	"vout-value":        "The amount in FLC",
	...
	"decodescriptresult-address":   "The flokicoin address associated with this script (only if a well-defined address exists)",
	"decodescriptresult-addresses": "(DEPRECATED) The flokicoin addresses associated with this script",
	...
	// EstimateFeeCmd help.
	"estimatefee--synopsis": "Estimate the fee per kilobyte in lokis " +
	...
	"estimatefee--result0": "Estimated fee per kilobyte in lokis for a block to " +
	...
	"getblockverboseresult-auxpow":            "AuxPoW data for merged mining (present on AuxPoW blocks).",

	// AuxPowResult help.
	"auxpowresult-tx":                "Parent coinbase transaction details.",
	"auxpowresult-index":             "Index in the coinbase merkle tree (usually 0).",
	"auxpowresult-chainindex":        "Index in the aux chain merkle tree.",
	"auxpowresult-merklebranch":      "Merkle branch from coinbase tx to parent merkle root (hex hashes).",
	"auxpowresult-chainmerklebranch": "Merkle branch from child hash to aux chain root (hex hashes).",
	"auxpowresult-parentblock":       "Parent block header as hex.",

	// AuxPowTxResult help.
	"auxpowtxresult-hex":      "Hex-encoded parent coinbase transaction.",
	"auxpowtxresult-txid":     "TXID of the parent coinbase transaction.",
	"auxpowtxresult-version":  "Version of the parent coinbase transaction.",
	"auxpowtxresult-vin":      "Inputs of the parent coinbase transaction.",
	"auxpowtxresult-vout":     "Outputs of the parent coinbase transaction.",
	"auxpowtxresult-locktime": "Locktime of the parent coinbase transaction.",

	// AuxPowVin help.
	"auxpowvin-coinbase": "Hex-encoded coinbase signature script.",

	// AuxPowVout help.
	"auxpowvout-value":        "Output value in loki (base units).",
	"auxpowvout-scriptPubKey": "Hex-encoded scriptPubKey.",
	...
	"getblocktemplateresulttx-fee":     "Difference in value between transaction inputs and outputs (in Loki)",
	...
	"getblocktemplateresult-coinbasevalue":              "Total amount available for the coinbase in Loki",
	...
	"getcurrentnet--synopsis": "Get flokicoin network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in FLC/KB",
	...
	"infowalletresult-balance":         "The total flokicoin balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in FLC/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in FLC/KB",
	...
	"getnetworkinfo--synopsis": "Returns a JSON object containing various state info.",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in flokicoins",
	...
	"gettxoutresult-value":         "The transaction amount in FLC",
	...
	"searchrawtransactions-address":     "The Flokicoin address to search for",
	...
	"validateaddresschainresult-address":         "The flokicoin address (only when isvalid is true)",
	...
	"validateaddress-address":   "Flokicoin address to validate",
	...
	"verifymessage-address":   "The flokicoin address to use for the signature",
	...
	"testmempoolaccept-maxfeerate": "Maximum acceptable fee rate in FLC/kB",
	...
	"testmempoolacceptfees-effective-feerate":  "The effective feerate in FLC per KvB.",
	...
	// ValidateAddressCmd result help.
	"validateaddresschainresult-scriptPubKey": "The script public key associated with the address.",

	// GetBlockCmd result help.
	"getblockverboseresult-chainwork": "The total amount of work in hexadecimal format that has been performed on the chain up to this block.",

	// GetRawTransactionCmd result help.
	"getrawtransaction-blockhash": "The hash of the block in which the transaction is included, if available.",

	// GetBlockchainInfoCmd result help.
	"getblockchaininforesult-warnings": "Any network or blockchain warnings related to the current state of the node.",

	// GetIndexInfoCmd result help.
	"indexinforesult-txindex": "Indicates whether the transaction index is enabled.",

	// EstimateSmartFeeCmd result help.
	"estimatesmartfee--result0": "The estimated fee rate in FLC per kilobyte for the requested confirmation target.",

	// GetBlockStatsCmd result help.

	// GetMempoolInfoCmd result help.
	"getmempoolinforesult-unbroadcastcount": "The number of transactions that have been submitted to the mempool but not yet broadcast to peers.",

	// InfoChainResult result help.
	"infochainresult-subversion":         "The subversion string of the node.",
	"infochainresult-localservices":      "A hex-encoded string of local services offered by the node.",
	"infochainresult-localservicesnames": "An array of readable names for the local services.",
	"infochainresult-localrelay":         "Indicates if transaction relay is enabled.",
	"infochainresult-networkactive":      "Indicates if the network is active.",
	"infochainresult-connections_in":     "The number of inbound connections.",
	"infochainresult-connections_out":    "The number of outbound connections.",
	"infochainresult-networks":           "An array of network-specific details.",
	"infochainresult-incrementalfee":     "The incremental fee rate per KB in FLC.",
	...
	"getmempoolentryresult-fee":             "The transaction fee in FLC.",
	"getmempoolentryresult-modifiedfee":     "The transaction fee after modifications (e.g., priority adjustments).",
	"getmempoolentryresult-time":            "The time when the transaction entered the mempool.",
	"getmempoolentryresult-height":          "The block height at which the transaction entered the mempool.",
	"getmempoolentryresult-descendantcount": "The number of descendant transactions.",
	"getmempoolentryresult-descendantsize":  "The combined size of descendant transactions in bytes.",
	"getmempoolentryresult-descendantfees":  "The combined fees of descendant transactions in FLC.",
	"getmempoolentryresult-ancestorcount":   "The number of ancestor transactions.",
	"getmempoolentryresult-ancestorsize":    "The combined size of ancestor transactions in bytes.",
	"getmempoolentryresult-ancestorfees":    "The combined fees of ancestor transactions in FLC.",
	...
	"getblockstatsresult-avgfee":              "The average transaction fee in the block in lokis.",
	"getblockstatsresult-avgfeerate":          "The average fee rate per vByte in lokis.",
	"getblockstatsresult-avgtxsize":           "The average transaction size in bytes.",
	"getblockstatsresult-feerate_percentiles": "Fee rate percentiles at different weight units in lokis per vByte.",
	"getblockstatsresult-blockhash":           "The hash of the block.",
	"getblockstatsresult-height":              "The height of the block.",
	"getblockstatsresult-ins":                 "The number of transaction inputs excluding the coinbase transaction.",
	"getblockstatsresult-maxfee":              "The maximum transaction fee in the block in lokis.",
	"getblockstatsresult-maxfeerate":          "The maximum fee rate per vByte in lokis.",
	"getblockstatsresult-maxtxsize":           "The maximum transaction size in bytes.",
	"getblockstatsresult-medianfee":           "The median transaction fee in the block in lokis.",
	"getblockstatsresult-mediantime":          "The median past time of the block.",
	"getblockstatsresult-mediantxsize":        "The median transaction size in bytes.",
	"getblockstatsresult-minfee":              "The minimum transaction fee in the block in lokis.",
	"getblockstatsresult-minfeerate":          "The minimum fee rate per vByte in lokis.",
	"getblockstatsresult-mintxsize":           "The minimum transaction size in bytes.",
	"getblockstatsresult-outs":                "The number of transaction outputs in the block.",
	"getblockstatsresult-swtotal_size":        "The total size of all SegWit transactions in bytes.",
	"getblockstatsresult-swtotal_weight":      "The total weight of all SegWit transactions.",
	"getblockstatsresult-swtxs":               "The number of SegWit transactions in the block.",
	"getblockstatsresult-subsidy":             "The block subsidy in lokis.",
	"getblockstatsresult-time":                "The time the block was mined.",
	"getblockstatsresult-total_out":           "The total amount transacted in the block excluding the coinbase transaction.",
	"getblockstatsresult-total_size":          "The total size of all non-coinbase transactions in bytes.",
	"getblockstatsresult-total_weight":        "The total weight of all non-coinbase transactions.",
	"getblockstatsresult-txs":                 "The total number of transactions in the block including the coinbase transaction.",
	"getblockstatsresult-utxo_increase":       "The net increase in the number of UTXOs.",
	"getblockstatsresult-utxo_size_inc":       "The net increase in size of the UTXO set in bytes.",

	// EstimateSmartFeeResult result help.
	"estimatesmartfeeresult-feerate": "The estimated fee rate in FLC per kilobyte for the requested confirmation target.",
	"estimatesmartfeeresult-errors":  "An array of errors encountered during fee estimation, if any.",
	"estimatesmartfeeresult-blocks":  "The number of blocks for which the fee rate estimate is valid.",

	// GetBlockStatsResult result help.
	"getblockstats-stats": "A collection of statistical data related to the block.",

	// GetBlockCmd result help.
	"getblockverboseresult-nTx": "The number of transactions in the block.",

	// EstimateSmartFeeResult result help.
	"estimatesmartfee-estimatemode": "The mode used for fee estimation, such as economical or conservative.",

	// GetIndexInfoCmd result help.
	"txindexresult-best_block_height": "The height of the best block for the transaction index.",

	// GetMempoolEntryResult result help.
	"mempoolfees-descendant": "The total fees of all descendant transactions.",

	// GetInfoCmd result help.
	"networksresult-proxy_randomize_credentials": "Indicates whether proxy credentials are randomized for privacy.",

	// GetMempoolInfoCmd result help.
	"getmempoolinforesult-minrelaytxfee": "The minimum relay fee for transactions in FLC per KB.",

	// EstimateSmartFeeResult result help.
	"estimatesmartfee-conftarget": "The targeted number of blocks within which the transaction should be confirmed.",

	// GetInfoCmd result help.
	"networksresult-proxy": "The proxy server used for network connections, if any.",

	// GetBlockStatsCmd result help.
	"hashorheight-value": "The block hash or height used to retrieve block statistics.",

	// GetMempoolEntryResult result help.
	"mempoolfees-ancestor": "The total fees of all ancestor transactions.",

	// GetMempoolInfoCmd result help.
	"getmempoolinforesult-mempoolminfee": "The minimum fee rate required for a transaction to enter the mempool in FLC per KB.",

	// GetIndexInfoCmd result help.
	"txindexresult-synced": "Indicates whether the transaction index is fully synchronized with the blockchain.",

	// GetIndexInfoCmd result help.
	"getindexinfo--synopsis": "Provides details on the current state of the transaction index.",

	// GetBlockStatsCmd result help.
	"getblockstats-hashorheight": "The block hash or height used to retrieve block statistics.",

	// GetInfoCmd result help.
	"networksresult-reachable": "Indicates whether the network is reachable on the given connection.",

	// GetMempoolInfoCmd result help.
	"getmempoolinforesult-maxmempool": "The maximum memory pool size in MB.",

	// EstimateSmartFeeCmd result help.
	"estimatesmartfee--synopsis": "Estimates the required fee rate for a transaction to be confirmed within a specified number of blocks.",

	// GetMempoolEntryResult result help.
	"mempoolfees-modified": "The modified fee used for fee-based transaction prioritization.",

	// GetInfoCmd result help.
	"networksresult-limited": "Indicates whether the connection to the network is limited.",

	// GetBlockStatsCmd result help.
	"getblockstats--synopsis": "Retrieves various statistical data for a given block using its hash or height.",

	// GetMempoolInfoCmd result help.
	"getmempoolinforesult-usage": "The current memory usage of the mempool in bytes.",

	// GetMempoolEntryResult result help.
	"mempoolfees-base": "The base transaction fee without modifications or priority adjustments.",

	// GetMempoolEntryResult result help.
	"getmempoolentry-txid": "The transaction ID (TXID) of the mempool entry.",

	// GetInfoCmd result help.
	"networksresult-name": "The name of the network (e.g., ipv4, ipv6, onion).",

	// GetMempoolInfoCmd result help.
	"getmempoolinforesult-loaded": "Indicates whether the mempool has been fully loaded.",

	// GetMempoolEntryCmd result help.
	"getmempoolentry--synopsis": "Retrieves detailed information about a transaction in the mempool, including its fee, size, dependencies, and ancestor/descendant data.",
}
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction": {(*chainjson.TxRawDecodeResult)(nil)},
	"decodescript":         {(*chainjson.DecodeScriptResult)(nil)},
	...
	"getmempoolinfo":         {(*chainjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":          {(*chainjson.GetMiningInfoResult)(nil)},
	"getnettotals":           {(*chainjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":       {(*float64)(nil)},
	"getnodeaddresses":       {(*[]chainjson.GetNodeAddressesResult)(nil)},
	"getpeerinfo":            {(*[]chainjson.GetPeerInfoResult)(nil)},
	"getrawmempool":          {(*[]string)(nil), (*chainjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":      {(*string)(nil), (*chainjson.TxRawResult)(nil)},
	"gettxout":               {(*chainjson.GetTxOutResult)(nil)},
	"node":                   nil,
	"help":                   {(*string)(nil), (*string)(nil)},
	"invalidateblock":        nil,
	"ping":                   nil,
	"reconsiderblock":        nil,
	"searchrawtransactions":  {(*string)(nil), (*[]chainjson.SearchRawTransactionsResult)(nil)},
	...
	"uptime":                 {(*int64)(nil)},
	"validateaddress":        {(*chainjson.ValidateAddressChainResult)(nil)},
	"verifychain":            {(*bool)(nil)},
	"verifymessage":          {(*bool)(nil)},
	"version":                {(*map[string]chainjson.VersionResult)(nil)},
	"testmempoolaccept":      {(*[]chainjson.TestMempoolAcceptResult)(nil)},
	"gettxspendingprevout":   {(*[]chainjson.GetTxSpendingPrevOutResult)(nil)},

	// Websocket commands.
	"loadtxfilter":              nil,
	"session":                   {(*chainjson.SessionResult)(nil)},
	"notifyblocks":              nil,
	...
	"stopnotifyspent":           nil,
	"rescan":                    nil,
	"rescanblocks":              {(*[]chainjson.RescannedBlock)(nil)},
}
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := chainjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := chainjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
