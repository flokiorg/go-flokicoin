...
commits](https://github.com/flokiorg/go-flokicoin/commits/master) for examples of
commit messages.
...
Rejoice as you will now be listed as a [contributor](https://github.com/flokiorg/go-flokicoin/graphs/contributors)!
