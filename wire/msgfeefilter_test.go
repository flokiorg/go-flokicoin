...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.FlcEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.FlcDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.FlcEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.FlcDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.FlcEncode(w, test.pver, BaseEncoding)
		...
		err = msg.FlcDecode(r, test.pver, BaseEncoding)
