...
// maxNetAddressPayload returns the max payload size for a flokicoin NetAddress
...
type NetAddress struct {
	...
	// not present in the flokicoin version message (MsgVersion) nor was it
...
func readNetAddressBuf(r io.Reader, pver uint32, na *NetAddress, ts bool,
	...
	// NOTE: The flokicoin protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Flokicoin protocol mixes little and big endian.
