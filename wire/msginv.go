...
// MsgInv implements the Message interface and represents a flokicoin inv message.
...
// NewMsgInv returns a new flokicoin inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new flokicoin inv message that conforms to the
