...
// flokicoin addr message (MsgAddr).
const MaxAddrPerMsg = 1000

// MsgAddr implements the Message interface and represents a flokicoin
...
// NewMsgAddr returns a new flokicoin addr message that conforms to the
