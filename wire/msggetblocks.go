...
// MsgGetBlocks implements the Message interface and represents a flokicoin
...
// NewMsgGetBlocks returns a new flokicoin getblocks message that conforms to the
