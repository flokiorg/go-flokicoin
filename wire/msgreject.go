...
// MsgReject implements the Message interface and represents a flokicoin reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	...
	// RejectVersion.
	if pver >= RejectVersion {
		// Unfortunately the flokicoin protocol does not enforce a sane
...
// NewMsgReject returns a new flokicoin reject message that conforms to the
