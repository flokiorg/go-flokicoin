...
func (msg *MsgGetCFCheckpt) FlcDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCFCheckpt) FlcEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
	buf := binarySerializer.Borrow()
	defer binarySerializer.Return(buf)
...
// NewMsgGetCFCheckpt returns a new flokicoin getcfcheckpt message that conforms
