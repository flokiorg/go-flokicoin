...
// MsgCFCheckpt implements the Message interface and represents a flokicoin
...
func (msg *MsgCFCheckpt) FlcDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgCFCheckpt) FlcEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
	buf := binarySerializer.Borrow()
	defer binarySerializer.Return(buf)
...
// NewMsgCFCheckpt returns a new flokicoin cfheaders message that conforms to
