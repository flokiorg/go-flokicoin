...
// MsgGetCFilters implements the Message interface and represents a flokicoin
...
func (msg *MsgGetCFilters) FlcDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCFilters) FlcEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
	buf := binarySerializer.Borrow()
	defer binarySerializer.Return(buf)
...
// NewMsgGetCFilters returns a new flokicoin getcfilters message that conforms to
