...
import (
	...
	"github.com/flokiorg/go-flokicoin/chainutil/coinset"
...
func NewCoin(index int64, value chainutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	// should be two outpoints, with 1st one having 0.035FLC value.
	...
	testSimpleCoinTxValue0            = chainutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = chainutil.NewTxFromBytes(testSimpleCoinTxBytes)
