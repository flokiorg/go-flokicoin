...
/*
Package hdkeychain provides an API for flokicoin hierarchical deterministic
...
Extended keys are much like normal Flokicoin addresses in that they have version
