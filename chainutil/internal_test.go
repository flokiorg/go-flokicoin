...
/*
This test file is part of the chainutil package rather than than the
chainutil_test package so it can bridge access to the internals to properly test
...
func TstAddressPubKey(serializedPubKey []byte, pubKeyFormat PubKeyFormat,
	...
	pubKey, _ := crypto.ParsePubKey(serializedPubKey)
...
// P2PKH and P2SH flokicoin addresses.
...
// bech32 encoded P2WPKH and P2WSH flokicoin addresses.
...
// bech32m encoded P2TR flokicoin address.
