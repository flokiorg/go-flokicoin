...
// Copyright (c) 2016-2017 The The Decred developers
...
# GCS use in Flokicoin

GCS filters are a proposed mechanism for storing and transmitting per-block
filters in Flokicoin. The usage is intended to be the inverse of Bloom filters:
...
probability for Flokicoin use is 2^-20.
*/
package gcs
