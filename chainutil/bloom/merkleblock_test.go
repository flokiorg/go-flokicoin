...
func TestMerkleBlock3(t *testing.T) {
	...
	blk, err := chainutil.NewBlockFromBytes(blockBytes)
	if err != nil {
	...
	err = mBlock.FlcEncode(got, wire.ProtocolVersion, wire.LatestEncoding)
	if err != nil {
		t.Errorf("TestMerkleBlock3 FlcEncode failed: %v", err)
		return
	}
