...
// Block defines a flokicoin block that provides easier and more efficient
...
// Transactions returns a slice of wrapped transactions (chainutil.Tx) for all
...
// instead provides easy access to wrapped versions (chainutil.Tx) of them.
...
// NewBlock returns a new instance of a flokicoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a flokicoin block given the
...
func NewBlockFromBytes(serializedBlock []byte) (*Block, error) {
	...
	// This initializes []chainutil.Tx to have the serialized raw
...
// NewBlockFromReader returns a new instance of a flokicoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a flokicoin block given
