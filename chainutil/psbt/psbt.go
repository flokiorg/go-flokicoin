...
// Package psbt is an implementation of Partially Signed Flokicoin
...
// isn't specified by the BIP but used by flokicoind in various places to limit
...
func (p *Packet) GetTxFee() (chainutil.Amount, error) {
	...
	return chainutil.Amount(fee), nil
}
