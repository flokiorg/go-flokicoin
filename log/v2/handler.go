...
type handlerOpts struct {
	...
	styledLevel func(flog.Level) string
...
func WithStyledLevel(fn func(flog.Level) string) HandlerOption {
	return func(opts *handlerOpts) {
		opts.styledLevel = fn
	}
}
...
func (d *DefaultHandler) Level() flog.Level {
...
//
// NOTE: This is part of the Handler interface.
func (d *DefaultHandler) SetLevel(level flog.Level) {
