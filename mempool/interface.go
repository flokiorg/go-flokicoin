...
type TxMempool interface {
	...
	RawMempoolVerbose() map[string]*chainjson.GetRawMempoolVerboseResult
	...
	FetchTransaction(txHash *chainhash.Hash) (*chainutil.Tx, error)
	...
	ProcessTransaction(tx *chainutil.Tx, allowOrphan,
	...
	// actions based on it.
	CheckMempoolAcceptance(tx *chainutil.Tx) (*MempoolAcceptResult, error)
	...
	CheckSpend(op wire.OutPoint) *chainutil.Tx
}
