...
import (
	...
	"github.com/flokiorg/go-flokicoin/database/internal/treap"
...
//
// For example, it is possible to directly extract Flokicoin transactions and/or
...
func openDB(dbPath string, network wire.FlokicoinNet, create bool) (database.DB, error) {
