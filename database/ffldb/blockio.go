...
const (
	...
	// The Flokicoin protocol encodes block height as int32, so max number of
...
func newBlockStore(basePath string, network wire.FlokicoinNet) (*blockStore, error) {
