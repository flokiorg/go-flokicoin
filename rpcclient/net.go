...
func (c *Client) NodeAsync(command chainjson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := chainjson.NewNodeCmd(command, host, connectSubCmd)
	return c.SendCmd(cmd)
}
...
func (c *Client) Node(command chainjson.NodeSubCmd, host string,
...
func (c *Client) GetNetworkInfo() (*chainjson.GetNetworkInfoResult, error) {
...
func (r FutureGetNodeAddressesResult) Receive() ([]chainjson.GetNodeAddressesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var nodeAddresses []chainjson.GetNodeAddressesResult
...
func (c *Client) GetNodeAddressesAsync(count *int32) FutureGetNodeAddressesResult {
	cmd := chainjson.NewGetNodeAddressesCmd(count)
	return c.SendCmd(cmd)
}

// GetNodeAddresses returns data about known node addresses.
func (c *Client) GetNodeAddresses(count *int32) ([]chainjson.GetNodeAddressesResult, error) {
