...
func (c *Client) legacyGetBlockRequest(hash string, verbose,
	...
	verboseJSON, err := json.Marshal(chainjson.Bool(verbose))
	if err != nil {
		return nil, err
	}
	verboseTxJSON, err := json.Marshal(chainjson.Bool(verboseTx))
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := chainjson.NewGetBlockCmd(hash, chainjson.Int(0))
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash) (*chainjson.GetBlockVerboseResult, error) {
...
func (r FutureGetBlockVerboseTxResult) Receive() (*chainjson.GetBlockVerboseTxResult, error) {
	res, err := r.client.waitForGetBlockRes(r.Response, r.hash, true, true)
	if err != nil {
		return nil, err
	}

	var blockResult chainjson.GetBlockVerboseTxResult
	err = json.Unmarshal(res, &blockResult)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseTxResult {
	...
	cmd := chainjson.NewGetBlockCmd(hash, chainjson.Int(2))
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*chainjson.GetBlockVerboseTxResult, error) {
...
func (r FutureGetChainTxStatsResult) Receive() (*chainjson.GetChainTxStatsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainTxStats chainjson.GetChainTxStatsResult
...
func (c *Client) GetChainTxStatsAsync() FutureGetChainTxStatsResult {
	cmd := chainjson.NewGetChainTxStatsCmd(nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksAsync(nBlocks int32) FutureGetChainTxStatsResult {
	cmd := chainjson.NewGetChainTxStatsCmd(&nBlocks, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksBlockHashAsync(nBlocks int32, blockHash chainhash.Hash) FutureGetChainTxStatsResult {
	hash := blockHash.String()
	cmd := chainjson.NewGetChainTxStatsCmd(&nBlocks, &hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetChainTxStats() (*chainjson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocks(nBlocks int32) (*chainjson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocksBlockHash(nBlocks int32, blockHash chainhash.Hash) (*chainjson.GetChainTxStatsResult, error) {
...
func unmarshalPartialGetBlockChainInfoResult(res []byte) (*chainjson.GetBlockChainInfoResult, error) {
	var chainInfo chainjson.GetBlockChainInfoResult
...
func unmarshalGetBlockChainInfoResultSoftForks(chainInfo *chainjson.GetBlockChainInfoResult,
	...
	if version.SupportUnifiedSoftForks() {
		...
		var softForks chainjson.SoftForks
		if err := json.Unmarshal(res, &softForks); err != nil {
			return err
		}
...
// result provided by the server.
func (r FutureGetBlockFilterResult) Receive() (*chainjson.GetBlockFilterResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var blockFilter chainjson.GetBlockFilterResult
...
func (c *Client) GetBlockFilterAsync(blockHash chainhash.Hash, filterType *chainjson.FilterTypeName) FutureGetBlockFilterResult {
	hash := blockHash.String()

	cmd := chainjson.NewGetBlockFilterCmd(hash, filterType)
	return c.SendCmd(cmd)
}

// GetBlockFilter retrieves a BIP0157 content filter for a particular block.
func (c *Client) GetBlockFilter(blockHash chainhash.Hash, filterType *chainjson.FilterTypeName) (*chainjson.GetBlockFilterResult, error) {
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := chainjson.NewGetBlockHeaderCmd(hash, chainjson.Bool(false))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := chainjson.NewGetBlockHeaderCmd(hash, chainjson.Bool(true))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*chainjson.GetBlockHeaderVerboseResult, error) {
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*chainjson.GetMempoolEntryResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult chainjson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := chainjson.NewGetMempoolEntryCmd(txHash)
	return c.SendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*chainjson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := chainjson.NewGetRawMempoolCmd(chainjson.Bool(false))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := chainjson.NewGetRawMempoolCmd(chainjson.Bool(true))
	return c.SendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]chainjson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) EstimateFeeAsync(numBlocks int64) FutureEstimateFeeResult {
	cmd := chainjson.NewEstimateFeeCmd(numBlocks)
	return c.SendCmd(cmd)
}

// EstimateFee provides an estimated fee  in flokicoins per kilobyte.
...
func (r FutureEstimateSmartFeeResult) Receive() (*chainjson.EstimateSmartFeeResult, error) {
	...
	var verified chainjson.EstimateSmartFeeResult
...
func (c *Client) EstimateSmartFeeAsync(confTarget int64, mode *chainjson.EstimateSmartFeeMode) FutureEstimateSmartFeeResult {
	cmd := chainjson.NewEstimateSmartFeeCmd(confTarget, mode)
	return c.SendCmd(cmd)
}

// EstimateSmartFee requests the server to estimate a fee level based on the given parameters.
func (c *Client) EstimateSmartFee(confTarget int64, mode *chainjson.EstimateSmartFeeMode) (*chainjson.EstimateSmartFeeResult, error) {
...
func (r FutureGetTxOutSetInfoResult) Receive() (*chainjson.GetTxOutSetInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutSetInfo *chainjson.GetTxOutSetInfoResult
...
func (c *Client) GetTxOutSetInfoAsync() FutureGetTxOutSetInfoResult {
	cmd := chainjson.NewGetTxOutSetInfoCmd()
	return c.SendCmd(cmd)
}

// GetTxOutSetInfo returns the statistics about the unspent transaction output
// set.
func (c *Client) GetTxOutSetInfo() (*chainjson.GetTxOutSetInfoResult, error) {
...
func (r FutureRescanBlocksResult) Receive() ([]chainjson.RescannedBlock, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []chainjson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := chainjson.NewRescanBlocksCmd(strBlockHashes)
	return c.SendCmd(cmd)
}
...
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]chainjson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := chainjson.NewInvalidateBlockCmd(hash)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash,
	...
	cmd := chainjson.NewGetCFilterCmd(hash, filterType)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash,
	...
	cmd := chainjson.NewGetCFilterHeaderCmd(hash, filterType)
	return c.SendCmd(cmd)
}
...
func (r FutureGetBlockStatsResult) Receive() (*chainjson.GetBlockStatsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var blockStats chainjson.GetBlockStatsResult
...
func (c *Client) GetBlockStatsAsync(hashOrHeight interface{}, stats *[]string) FutureGetBlockStatsResult {
	...
	cmd := chainjson.NewGetBlockStatsCmd(chainjson.HashOrHeight{Value: hashOrHeight}, stats)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBlockStats(hashOrHeight interface{}, stats *[]string) (*chainjson.GetBlockStatsResult, error) {
...
func (r FutureDeriveAddressesResult) Receive() (*chainjson.DeriveAddressesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var deriveAddressesResult chainjson.DeriveAddressesResult
...
func (c *Client) DeriveAddressesAsync(descriptor string, descriptorRange *chainjson.DescriptorRange) FutureDeriveAddressesResult {
	cmd := chainjson.NewDeriveAddressesCmd(descriptor, descriptorRange)
	return c.SendCmd(cmd)
}
...
func (c *Client) DeriveAddresses(descriptor string, descriptorRange *chainjson.DescriptorRange) (*chainjson.DeriveAddressesResult, error) {
...
func (r FutureGetDescriptorInfoResult) Receive() (*chainjson.GetDescriptorInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var descriptorInfo chainjson.GetDescriptorInfoResult
...
func (c *Client) GetDescriptorInfoAsync(descriptor string) FutureGetDescriptorInfoResult {
	cmd := chainjson.NewGetDescriptorInfoCmd(descriptor)
	return c.SendCmd(cmd)
}
...
//
// See chainjson.GetDescriptorInfoResult for details about the result.
func (c *Client) GetDescriptorInfo(descriptor string) (*chainjson.GetDescriptorInfoResult, error) {
...
func (c *Client) ReconsiderBlockAsync(
	...
	cmd := chainjson.NewReconsiderBlockCmd(hash)
	return c.SendCmd(cmd)
}
