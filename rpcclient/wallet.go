...
func (r FutureGetTransactionResult) Receive() (*chainjson.GetTransactionResult, error) {
	...
	var getTx chainjson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := chainjson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*chainjson.GetTransactionResult, error) {
...
func (c *Client) GetTransactionWatchOnlyAsync(txHash *chainhash.Hash, watchOnly bool) FutureGetTransactionResult {
	...
	cmd := chainjson.NewGetTransactionCmd(hash, &watchOnly)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetTransactionWatchOnly(txHash *chainhash.Hash, watchOnly bool) (*chainjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]chainjson.ListTransactionsResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := chainjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]chainjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := chainjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.SendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]chainjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := chainjson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]chainjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromWatchOnlyAsync(account string, count, from int, watchOnly bool) FutureListTransactionsResult {
	cmd := chainjson.NewListTransactionsCmd(&account, &count, &from, &watchOnly)
	return c.SendCmd(cmd)
}
...
//
// See the ListTransactions and ListTransactionsCount functions to use defaults.
func (c *Client) ListTransactionsCountFromWatchOnly(account string, count, from int, watchOnly bool) ([]chainjson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]chainjson.ListUnspentResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []chainjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := chainjson.NewListUnspentCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := chainjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := chainjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []chainutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := chainjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]chainjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]chainjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]chainjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []chainutil.Address) ([]chainjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*chainjson.ListSinceBlockResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult chainjson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = chainjson.String(blockHash.String())
	}

	cmd := chainjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*chainjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := chainjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*chainjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfWatchOnlyAsync(blockHash *chainhash.Hash, minConfirms int, watchOnly bool) FutureListSinceBlockResult {
	...
	cmd := chainjson.NewListSinceBlockCmd(hash, &minConfirms, &watchOnly)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConfWatchOnly(blockHash *chainhash.Hash, minConfirms int, watchOnly bool) (*chainjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	...
	cmd := chainjson.NewLockUnspentCmd(unlock, outputs)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := chainjson.NewListLockUnspentCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) SetTxFeeAsync(fee chainutil.Amount) FutureSetTxFeeResult {
	cmd := chainjson.NewSetTxFeeCmd(fee.ToFLC())
	return c.SendCmd(cmd)
}
...
func (c *Client) SendToAddressAsync(address chainutil.Address, amount chainutil.Amount) FutureSendToAddressResult {
	...
	cmd := chainjson.NewSendToAddressCmd(addr, amount.ToFLC(), nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendToAddressCommentAsync(address chainutil.Address,
	amount chainutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := chainjson.NewSendToAddressCmd(addr, amount.ToFLC(), &comment,
		&commentTo)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address chainutil.Address, amount chainutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress chainutil.Address, amount chainutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := chainjson.NewSendFromCmd(fromAccount, addr, amount.ToFLC(), nil,
		nil, nil)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress chainutil.Address, amount chainutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress chainutil.Address, amount chainutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := chainjson.NewSendFromCmd(fromAccount, addr, amount.ToFLC(),
		&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress chainutil.Address, amount chainutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress chainutil.Address, amount chainutil.Amount, minConfirms int,
...
func (c *Client) SendFromComment(fromAccount string, toAddress chainutil.Address,
	amount chainutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[chainutil.Address]chainutil.Amount) FutureSendManyResult {
	...
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToFLC()
	}
	cmd := chainjson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[chainutil.Address]chainutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[chainutil.Address]chainutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (chainutil.Address, error) {
	...
	return chainutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []chainutil.Address, account string) FutureAddMultisigAddressResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := chainjson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []chainutil.Address, account string) (chainutil.Address, error) {
...
func (r FutureCreateMultisigResult) Receive() (*chainjson.CreateMultiSigResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes chainjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []chainutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := chainjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.SendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []chainutil.Address) (*chainjson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := chainjson.NewCreateNewAccountCmd(account)
	return c.SendCmd(cmd)
}
...
func (r FutureCreateWalletResult) Receive() (*chainjson.CreateWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var createWalletResult chainjson.CreateWalletResult
...
// method.
type CreateWalletOpt func(*chainjson.CreateWalletCmd)
...
func WithCreateWalletDisablePrivateKeys() CreateWalletOpt {
	return func(c *chainjson.CreateWalletCmd) {
		c.DisablePrivateKeys = chainjson.Bool(true)
	}
}
...
func WithCreateWalletPassphrase(value string) CreateWalletOpt {
	return func(c *chainjson.CreateWalletCmd) {
		c.Passphrase = chainjson.String(value)
	}
}
...
func WithCreateWalletAvoidReuse() CreateWalletOpt {
	return func(c *chainjson.CreateWalletCmd) {
		c.AvoidReuse = chainjson.Bool(true)
	}
}
...
func (c *Client) CreateWalletAsync(name string, opts ...CreateWalletOpt) FutureCreateWalletResult {
	cmd := chainjson.NewCreateWalletCmd(name, nil, nil, nil, nil)
...
func (c *Client) CreateWallet(name string, opts ...CreateWalletOpt) (*chainjson.CreateWalletResult, error) {
...
// about the given flokicoin address.
func (r FutureGetAddressInfoResult) Receive() (*chainjson.GetAddressInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var getAddressInfoResult chainjson.GetAddressInfoResult
...
func (c *Client) GetAddressInfoAsync(address string) FutureGetAddressInfoResult {
	cmd := chainjson.NewGetAddressInfoCmd(address)
	return c.SendCmd(cmd)
}

// GetAddressInfo returns information about the given flokicoin address.
func (c *Client) GetAddressInfo(address string) (*chainjson.GetAddressInfoResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (chainutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := chainjson.NewGetNewAddressCmd(&account, nil)
...
// chain params.
func (c *Client) GetNewAddress(account string) (chainutil.Address, error) {
...
func (c *Client) GetNewAddressTypeAsync(account, addrType string) FutureGetNewAddressResult {
	cmd := chainjson.NewGetNewAddressCmd(&account, &addrType)
	result := FutureGetNewAddressResult{
		network:         c.chainParams,
		responseChannel: c.SendCmd(cmd),
	}
...
// chain params.
func (c *Client) GetNewAddressType(account, addrType string) (chainutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (chainutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := chainjson.NewGetRawChangeAddressCmd(&account, nil)
...
func (c *Client) GetRawChangeAddress(account string) (chainutil.Address, error) {
...
func (c *Client) GetRawChangeAddressTypeAsync(account, addrType string) FutureGetRawChangeAddressResult {
	cmd := chainjson.NewGetRawChangeAddressCmd(&account, &addrType)
	result := FutureGetRawChangeAddressResult{
		network:         c.chainParams,
		responseChannel: c.SendCmd(cmd),
	}
...
// transactions and NOT for normal use.
func (c *Client) GetRawChangeAddressType(account, addrType string) (chainutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (chainutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddressAsync(address string) FutureAddWitnessAddressResult {
	cmd := chainjson.NewAddWitnessAddressCmd(address)
...
func (c *Client) AddWitnessAddress(address string) (chainutil.Address, error) {
...
// Flokicoin address for receiving payments to the specified account.
func (r FutureGetAccountAddressResult) Receive() (chainutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := chainjson.NewGetAccountAddressCmd(account)
...
// GetAccountAddress returns the current Flokicoin address for receiving payments
// to the specified account.
func (c *Client) GetAccountAddress(account string) (chainutil.Address, error) {
...
func (c *Client) GetAccountAsync(address chainutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := chainjson.NewGetAccountCmd(addr)
	return c.SendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address chainutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address chainutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := chainjson.NewSetAccountCmd(addr, account)
	return c.SendCmd(cmd)
}

// SetAccount sets the account associated with the passed address.
func (c *Client) SetAccount(address chainutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]chainutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]chainutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = chainutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := chainjson.NewGetAddressesByAccountCmd(account)
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]chainutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount chainutil.Amount) FutureMoveResult {
	cmd := chainjson.NewMoveCmd(fromAccount, toAccount, amount.ToFLC(), nil,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	...
	cmd := chainjson.NewMoveCmd(fromAccount, toAccount, amount.ToFLC(),
		&minConfirms, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := chainjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.SendCmd(cmd)
}
...
// about the given flokicoin address.
func (r FutureValidateAddressResult) Receive() (*chainjson.ValidateAddressWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult chainjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address chainutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := chainjson.NewValidateAddressCmd(addr)
	return c.SendCmd(cmd)
}

// ValidateAddress returns information about the given flokicoin address.
func (c *Client) ValidateAddress(address chainutil.Address) (*chainjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := chainjson.NewKeyPoolRefillCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := chainjson.NewKeyPoolRefillCmd(&newSize)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := chainjson.NewListAccountsCmd(nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := chainjson.NewListAccountsCmd(&minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := chainjson.NewGetBalanceCmd(&account, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (chainutil.Amount, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := chainjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (chainutil.Amount, error) {
...
func (r FutureGetBalancesResult) Receive() (*chainjson.GetBalancesResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a floating point number.
	var balances chainjson.GetBalancesResult
...
func (c *Client) GetBalancesAsync() FutureGetBalancesResult {
	cmd := chainjson.NewGetBalancesCmd()
	return c.SendCmd(cmd)
}

// GetBalances returns the available balances from the server.
func (c *Client) GetBalances() (*chainjson.GetBalancesResult, error) {
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := chainjson.NewGetReceivedByAccountCmd(account, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := chainjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := chainjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.SendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressAsync(address chainutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := chainjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.SendCmd(cmd)
...
func (c *Client) GetReceivedByAddressMinConfAsync(address chainutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := chainjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.SendCmd(cmd)
}
...
// Receive waits for the Response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]chainjson.ListReceivedByAccountResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []chainjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := chainjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]chainjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := chainjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]chainjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := chainjson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]chainjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the Response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]chainjson.ListReceivedByAddressResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []chainjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := chainjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]chainjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := chainjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.SendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]chainjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := chainjson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]chainjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletLockAsync() FutureWalletLockResult {
	cmd := chainjson.NewWalletLockCmd()
	return c.SendCmd(cmd)
}
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := chainjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := chainjson.NewWalletPassphraseChangeCmd(old, new)
	return c.SendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address chainutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := chainjson.NewSignMessageCmd(addr, message)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address chainutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address chainutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address chainutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*chainutil.WIF, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return chainutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address chainutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := chainjson.NewDumpPrivKeyCmd(addr)
	return c.SendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address chainutil.Address) (*chainutil.WIF, error) {
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := chainjson.NewImportAddressCmd(address, "", nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, account string, rescan bool) FutureImportAddressResult {
	cmd := chainjson.NewImportAddressCmd(address, account, &rescan)
	return c.SendCmd(cmd)
}
...
func (r FutureImportMultiResult) Receive() (chainjson.ImportMultiResults, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var importMultiResults chainjson.ImportMultiResults
...
func (c *Client) ImportMultiAsync(requests []chainjson.ImportMultiRequest, options *chainjson.ImportMultiOptions) FutureImportMultiResult {
	cmd := chainjson.NewImportMultiCmd(requests, options)
	return c.SendCmd(cmd)
}
...
//
// See chainjson.ImportMultiRequest for details on the requests parameter.
func (c *Client) ImportMulti(requests []chainjson.ImportMultiRequest, options *chainjson.ImportMultiOptions) (chainjson.ImportMultiResults, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *chainutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := chainjson.NewImportPrivKeyCmd(wif, nil, nil)
	return c.SendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *chainutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *chainutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := chainjson.NewImportPrivKeyCmd(wif, &label, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *chainutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *chainutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := chainjson.NewImportPrivKeyCmd(wif, &label, &rescan)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *chainutil.WIF, label string, rescan bool) error {
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := chainjson.NewImportPubKeyCmd(pubKey, nil)
	return c.SendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := chainjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.SendCmd(cmd)
}
...
// NOTE: While getinfo is implemented here (in wallet.go), a flokicoind chain server
...
func (r FutureGetInfoResult) Receive() (*chainjson.InfoWalletResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes chainjson.InfoWalletResult
...
func (c *Client) GetInfo() (*chainjson.InfoWalletResult, error) {
...
func (r FutureWalletCreateFundedPsbtResult) Receive() (*chainjson.WalletCreateFundedPsbtResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var psbtRes chainjson.WalletCreateFundedPsbtResult
...
func (c *Client) WalletCreateFundedPsbtAsync(
	inputs []chainjson.PsbtInput, outputs []chainjson.PsbtOutput, locktime *uint32,
	options *chainjson.WalletCreateFundedPsbtOpts, bip32Derivs *bool,
) FutureWalletCreateFundedPsbtResult {
	cmd := chainjson.NewWalletCreateFundedPsbtCmd(inputs, outputs, locktime, options, bip32Derivs)
	return c.SendCmd(cmd)
}
...
func (c *Client) WalletCreateFundedPsbt(
	inputs []chainjson.PsbtInput, outputs []chainjson.PsbtOutput, locktime *uint32,
	options *chainjson.WalletCreateFundedPsbtOpts, bip32Derivs *bool,
) (*chainjson.WalletCreateFundedPsbtResult, error) {
...
func (r FutureWalletProcessPsbtResult) Receive() (*chainjson.WalletProcessPsbtResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var psbtRes chainjson.WalletProcessPsbtResult
	err = json.Unmarshal(res, &psbtRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) WalletProcessPsbtAsync(
	...
	cmd := chainjson.NewWalletProcessPsbtCmd(psbt, sign, chainjson.String(sighashType.String()), bip32Derivs)
	return c.SendCmd(cmd)
}
...
func (c *Client) WalletProcessPsbt(
	psbt string, sign *bool, sighashType SigHashType, bip32Derivs *bool,
) (*chainjson.WalletProcessPsbtResult, error) {
...
func (r FutureGetWalletInfoResult) Receive() (*chainjson.GetWalletInfoResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var getWalletInfoResult chainjson.GetWalletInfoResult
...
func (c *Client) GetWalletInfoAsync() FutureGetWalletInfoResult {
	cmd := chainjson.NewGetWalletInfoCmd()
	return c.SendCmd(cmd)
}

// GetWalletInfo returns various wallet state info.
func (c *Client) GetWalletInfo() (*chainjson.GetWalletInfoResult, error) {
...
func (c *Client) BackupWalletAsync(destination string) FutureBackupWalletResult {
	return c.SendCmd(chainjson.NewBackupWalletCmd(destination))
}
...
// Receive waits for the Response promised by the future
func (r FutureDumpWalletResult) Receive() (*chainjson.DumpWalletResult, error) {
	bytes, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}

	var res chainjson.DumpWalletResult
...
func (c *Client) DumpWalletAsync(destination string) FutureDumpWalletResult {
	return c.SendCmd(chainjson.NewDumpWalletCmd(destination))
}

// DumpWallet dumps all wallet keys in a human-readable format to a server-side file.
func (c *Client) DumpWallet(destination string) (*chainjson.DumpWalletResult, error) {
...
func (c *Client) ImportWalletAsync(filename string) FutureImportWalletResult {
	return c.SendCmd(chainjson.NewImportWalletCmd(filename))
}
...
func (c *Client) UnloadWalletAsync(walletName *string) FutureUnloadWalletResult {
	return c.SendCmd(chainjson.NewUnloadWalletCmd(walletName))
}

// UnloadWallet unloads the referenced wallet. If the RPC server URL already
// contains the name of the wallet, like http://127.0.0.1:15213/wallet/<walletname>,
...
// Receive waits for the Response promised by the future
func (r FutureLoadWalletResult) Receive() (*chainjson.LoadWalletResult, error) {
	bytes, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	var result chainjson.LoadWalletResult
...
func (c *Client) LoadWalletAsync(walletName string) FutureLoadWalletResult {
	return c.SendCmd(chainjson.NewLoadWalletCmd(walletName))
}

// LoadWallet loads a wallet from a wallet file or directory.
func (c *Client) LoadWallet(walletName string) (*chainjson.LoadWalletResult, error) {
	return c.LoadWalletAsync(walletName).Receive()
}

// TODO(davec): Implement
// encryptwallet (Won't be supported by walletd since it's always encrypted)
// listaddressgroupings (NYI in walletd)
// listreceivedbyaccount (NYI in walletd)
