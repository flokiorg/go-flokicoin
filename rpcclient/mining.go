...
func (c *Client) GenerateToAddressAsync(numBlocks int64, address chainutil.Address, maxTries *int64) FutureGenerateToAddressResult {
	cmd := chainjson.NewGenerateToAddressCmd(numBlocks, address.EncodeAddress(), maxTries)
	return c.SendCmd(cmd)
}

// GenerateToAddress generates numBlocks blocks to the given address and returns their hashes.
func (c *Client) GenerateToAddress(numBlocks int64, address chainutil.Address, maxTries *int64) ([]*chainhash.Hash, error) {
...
func (c *Client) SubmitBlockAsync(block *chainutil.Block, options *chainjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
// SubmitBlock attempts to submit a new block into the flokicoin network.
func (c *Client) SubmitBlock(block *chainutil.Block, options *chainjson.SubmitBlockOptions) error {
...
func (r FutureGetBlockTemplateResponse) Receive() (*chainjson.GetBlockTemplateResult, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockTemplateAsync(req *chainjson.TemplateRequest) FutureGetBlockTemplateResponse {
